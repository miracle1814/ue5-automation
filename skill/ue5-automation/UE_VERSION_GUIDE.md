...
| **5.8** | ⚠️ 需重编译 bridge + **MSVC ≥ 14.44** | 路径 B；注意 5.8 UBT 封禁 MSVC 14.40–14.43，14.38 撞引擎 C7539 → 需 14.44+（Epic 建议 14.50.35717）；另随包 `bridge/ue58-extras/` 可在官方 MCP 下开箱用 6 个纯 Python 工具 | 1–3 小时 |
